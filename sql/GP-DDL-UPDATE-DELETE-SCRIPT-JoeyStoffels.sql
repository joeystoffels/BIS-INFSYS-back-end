...
-- Deze is verwijderd in het alteration script, en komt later weer terug (zie 'Foreign keys uit alterations')
...
-- Deze zijn verwijderd in het alteration script, en komt later weer terug (zie 'Foreign keys uit alterations')
...
-- Is komen te vervallen ivm. database aanpassingen.
