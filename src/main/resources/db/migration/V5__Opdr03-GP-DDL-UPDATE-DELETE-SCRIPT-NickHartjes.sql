...
--
ALTER TABLE ARTIKEL
  DROP CONSTRAINT FK_ARTIKEL_SPEL;
ALTER TABLE ARTIKEL
  ADD CONSTRAINT FK_ARTIKEL_IS_SPEL FOREIGN KEY (TITEL, UITGEVER, JAAR_UITGAVE) REFERENCES SPEL (TITEL, UITGEVER, JAAR_UITGAVE)
  ON UPDATE CASCADE
  ON DELETE NO ACTION;
GO
...
ALTER TABLE HUUROVEREENKOMST
  DROP CONSTRAINT FK_HUUROVEREENKOMST_KLANT;
ALTER TABLE HUUROVEREENKOMST
  ADD CONSTRAINT FK_HUUROVEREENKOMST_KLANT FOREIGN KEY (EMAILADRES) REFERENCES KLANT (EMAILADRES)
  ON UPDATE CASCADE
  ON DELETE NO ACTION;

--
ALTER TABLE KLANTTELEFOONNR
  DROP CONSTRAINT FK_KLANTTELEFOONNUMMER_HEEFT_NUMMER;
ALTER TABLE KLANTTELEFOONNR
  ADD CONSTRAINT FK_KLANTTELEFOONNUMMER_HEEFT_NUMMER FOREIGN KEY (TELNUMMER) REFERENCES TELEFOONNUMMER (TELNUMMER)
  ON UPDATE CASCADE
  ON DELETE NO ACTION;

--
ALTER TABLE KLANTTELEFOONNR
  DROP CONSTRAINT FK_KLANTTELEFOONNUMMER_HOORT_BIJ_KLANT;
ALTER TABLE KLANTTELEFOONNR
  ADD CONSTRAINT FK_KLANTTELEFOONNUMMER_HOORT_BIJ_KLANT FOREIGN KEY (EMAILADRES) REFERENCES KLANT (EMAILADRES)
  ON UPDATE CASCADE
  ON DELETE NO ACTION;

--
ALTER TABLE VERKOOPOVEREENKOMST
  DROP CONSTRAINT FK_KOOP_AAN_KLANT;
ALTER TABLE VERKOOPOVEREENKOMST
  ADD CONSTRAINT FK_KOOP_AAN_KLANT FOREIGN KEY (EMAILADRES) REFERENCES KLANT (EMAILADRES)
  ON UPDATE CASCADE
  ON DELETE NO ACTION;
...
ALTER TABLE INKOOPOVEREENKOMST
  DROP CONSTRAINT FK_INKOOP_VAN_KLANT;
ALTER TABLE INKOOPOVEREENKOMST
  ADD CONSTRAINT FK_INKOOP_VAN_KLANT FOREIGN KEY (EMAILADRES) REFERENCES KLANT (EMAILADRES)
  ON UPDATE CASCADE
  ON DELETE NO ACTION;
...
ALTER TABLE MEDEWERKERROL
  DROP CONSTRAINT FK_MEDEWERKER_IS_ROL;
ALTER TABLE MEDEWERKERROL
  ADD CONSTRAINT FK_MEDEWERKER_IS_ROL FOREIGN KEY (ROL) REFERENCES ROL (ROL)
  ON UPDATE CASCADE
  ON DELETE NO ACTION;

--
ALTER TABLE MEDEWERKERROL
  DROP CONSTRAINT FK_MEDEWERKER_HEEFT_ROL;
ALTER TABLE MEDEWERKERROL
  ADD CONSTRAINT FK_MEDEWERKER_HEEFT_ROL FOREIGN KEY (INLOGNAAM) REFERENCES MEDEWERKER (INLOGNAAM)
  ON UPDATE CASCADE
  ON DELETE NO ACTION;

--
ALTER TABLE REPARATIE
  DROP CONSTRAINT FK_REPARATIE_DOOR_MEDEWERKER;
ALTER TABLE REPARATIE
  ADD CONSTRAINT FK_REPARATIE_DOOR_MEDEWERKER FOREIGN KEY (INLOGNAAM) REFERENCES MEDEWERKER (INLOGNAAM)
  ON UPDATE CASCADE
  ON DELETE NO ACTION;

ALTER TABLE REPARATIE
  ADD CONSTRAINT FK_REPARATIE_BIJ_ARTIKELVERHUUR FOREIGN KEY (BARCODE, EMAILADRES, STARTDATUM) REFERENCES ARTIKELENVERHUUR (BARCODE, EMAILADRES, STARTDATUM);
...
ALTER TABLE SPELTYPEPERSPEL
  DROP CONSTRAINT FK_SPELTYPE_PER_SPEL;
ALTER TABLE SPELTYPEPERSPEL
...
--
ALTER TABLE CONSOLE
  DROP CONSTRAINT FK_MERK_CONSOLES;
ALTER TABLE CONSOLE
  ADD CONSTRAINT FK_MERK_CONSOLE FOREIGN KEY (MERK_NAAM) REFERENCES CONSOLE_MERK (MERK_NAAM)
  ON UPDATE CASCADE
  ON DELETE NO ACTION;

--
ALTER TABLE CONSOLE
  DROP CONSTRAINT FK_TYPE_CONSOLES;
ALTER TABLE CONSOLE
  ADD CONSTRAINT FK_TYPE_CONSOLE FOREIGN KEY (TYPE_NAAM) REFERENCES CONSOLE_TYPE (TYPE_NAAM)
  ON UPDATE CASCADE
  ON DELETE NO ACTION;

--
ALTER TABLE ARTIKELENVERHUUR
  DROP CONSTRAINT FK_ARTIKEL;
ALTER TABLE ARTIKELENVERHUUR
  ADD CONSTRAINT FK_ARTIKELENVERHUUR_ARTIKEL FOREIGN KEY (BARCODE) REFERENCES ARTIKEL (BARCODE)
  ON UPDATE CASCADE
  ON DELETE NO ACTION;

-- DELETE laten cascaden?
ALTER TABLE ARTIKELENVERHUUR
  ADD CONSTRAINT FK_ARTIKELENVERHUUR_HUUROVEREENKOMST FOREIGN KEY (EMAILADRES, STARTDATUM) REFERENCES HUUROVEREENKOMST (EMAILADRES, STARTDATUM)
  ON UPDATE NO ACTION
  ON DELETE CASCADE;

-- DELETE laten cascaden?
ALTER TABLE ARTIKELENVERKOOP
  ADD CONSTRAINT FK_ARTIKELENVERKOOP_VERKOOPOVEREENKOMST FOREIGN KEY (EMAILADRES, DATUM) REFERENCES VERKOOPOVEREENKOMST (EMAILADRES, DATUM)
  ON UPDATE NO ACTION
  ON DELETE CASCADE;

--
ALTER TABLE ARTIKELENVERKOOP
  DROP CONSTRAINT FK_ARTIKELENVERKOOP_ARTIKEL;
ALTER TABLE ARTIKELENVERKOOP
...
ALTER TABLE ARTIKELENINKOOP
  DROP CONSTRAINT FK_ARTIKELENINKOOP_INKOOPOVEREENKOMST;
ALTER TABLE ARTIKELENINKOOP
...
--
ALTER TABLE ARTIKELENINKOOP
  DROP CONSTRAINT FK_ARTIKELENINKOOP_ARTIKEL;
ALTER TABLE ARTIKELENINKOOP
...
-- 
ALTER TABLE REPARATIE
  DROP CONSTRAINT FK_REPARATIE_ARTIKEL;
ALTER TABLE REPARATIE
