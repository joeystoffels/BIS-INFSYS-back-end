...
INSERT INTO LEEFTIJDSCATEGORIE
  SELECT DISTINCT LEEFTIJDSCATEGORIE
  FROM SPEL;
...
ALTER TABLE SPEL
  ALTER COLUMN UITGEVER VARCHAR(150) NOT NULL

ALTER TABLE SPEL
  ALTER COLUMN JAAR_UITGAVE INTEGER NOT NULL
...
CREATE TABLE CONSOLES (
  ...
  HUIDIGE_PRIJS DECIMAL(6, 2) NULL,
